...
const messageEnd = ` Вы сделали запрос на получение забытого пароля на сайте <b>https://Learning by cards<b> Чтобы получить новый пароль, пройдите по ссылке ниже:
\t\t</div>
...
export const forgotAPI = {
  sendLetter: async (email: string, name: string) => {
    const message = messageStart + `Уважаемый <b>${name}</b>.` + messageEnd
